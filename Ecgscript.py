...
app.config['MAIL_USERNAME'] = 'eng22am0036@dsu.edu.in'  # Replace with your email
app.config['MAIL_PASSWORD'] = 'Dsuam@036'  # Replace with your email password
app.config['MAIL_DEFAULT_SENDER'] = 'eng22am0036@dsu.edu.in'  # Default sender
mail = Mail(app)
...
def load_model():
    ...
    model_path = r"C:\Users\LENOVO\Desktop\ecgbackendfull\RESNET.pth"  # Replace with your model path
